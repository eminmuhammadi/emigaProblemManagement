            ...
            <div class="row mb-5"> 
              <div class="col-12 col-lg-8">
                  <h4 class=""><b>Mənim <?php
                    ...
                    else{echo "işlərim <h1 class=\"badge badge-primary\"><b>".$_SESSION["user_department_detail"]."</b></h1>";}
...
if (!empty($_GET['order'])) { 
      ...
      if($_SESSION['user_permission']=="U"){
          ...
          */ 
          ...
          $select_posts ="SELECT problem_id ,   department_detail , user_detail , problem_title , problem_status , reg_date FROM posts WHERE problem_status='P' && user_detail='$user_d' ORDER BY problem_id DESC";  
          ...
          */ 
          ...
          $select_posts ="SELECT problem_id ,   department_detail , user_detail , problem_title , problem_status , reg_date  FROM posts WHERE problem_status='C' && user_detail='$user_d' ORDER BY problem_id DESC";  
          $result = mysqli_query($connect, $select_posts);}
          ...
          */ 
          ...
          $select_posts ="SELECT problem_id ,   department_detail , user_detail , problem_title , problem_status , reg_date  FROM posts WHERE problem_status='D' && user_detail='$user_d' ORDER BY problem_id DESC";  
          $result = mysqli_query($connect, $select_posts);}
          ...
          *  SQL
          */  
         $select_posts ="SELECT problem_id ,  department_detail , user_detail , problem_title , problem_status , reg_date FROM posts WHERE problem_status='V' && user_detail='$user_d' ORDER BY problem_id DESC";  
          $result = mysqli_query($connect, $select_posts);  }
       ...
       */
        ...
        else if($_SESSION['user_permission']=="GA" || $_SESSION['user_permission']=="A" ){
    ...
    if($_SESSION['user_permission']=="U"){
       ...
       *  SQL
       */     
      $select_posts ="SELECT problem_id ,   department_detail , user_detail , problem_title , problem_status , reg_date FROM posts WHERE user_detail='$user_d' ORDER BY problem_id DESC";
      $result = mysqli_query($connect, $select_posts);
    }
    else if ($_SESSION['user_permission']=="GA" || $_SESSION['user_permission']=="A"){
      /*
