<?php
    ...
    $today_p = mysqli_query($connect,"SELECT problem_id FROM posts WHERE problem_status='P' && reg_date > CURDATE()");
    $today_p = mysqli_num_rows($today_p);

    $today_d = mysqli_query($connect,"SELECT problem_id FROM posts WHERE problem_status='D' && reg_date > CURDATE()");
    $today_d = mysqli_num_rows($today_d);

    $today_c = mysqli_query($connect,"SELECT problem_id FROM posts WHERE problem_status='C' && reg_date > CURDATE()");
    $today_c = mysqli_num_rows($today_c);

    $today_v = mysqli_query($connect,"SELECT problem_id FROM posts WHERE problem_status='V' && reg_date > CURDATE()");
    ...
    $all_problems_today = mysqli_query($connect,"SELECT problem_id FROM posts WHERE reg_date > CURDATE()");
    $all_problems_today = mysqli_num_rows($all_problems_today);

    $all_problems_month = mysqli_query($connect,"SELECT problem_id FROM posts WHERE reg_date > curdate() - interval 30 day");
